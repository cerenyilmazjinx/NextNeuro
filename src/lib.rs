...
#[derive(Debug)]
pub struct NextNeuroProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NextNeuroProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NextNeuro processing");
    
    let mut processor = NextNeuroProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NextNeuroProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NextNeuroProcessor::new(false);
